...
# Download LLVM 3.7.0
RUN wget https://releases.llvm.org/3.7.0/llvm-3.7.0.src.tar.xz && \
    tar xf llvm-3.7.0.src.tar.xz && \
    mv llvm-3.7.0.src llvm

# Download Clang 3.7.0
RUN wget https://releases.llvm.org/3.7.0/cfe-3.7.0.src.tar.xz && \
    tar xf cfe-3.7.0.src.tar.xz && \
    mv cfe-3.7.0.src llvm/tools/clang

# Download Compiler-RT 3.7.0
RUN wget https://releases.llvm.org/3.7.0/compiler-rt-3.7.0.src.tar.xz && \
