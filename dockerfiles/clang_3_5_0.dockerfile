...
# Download Clang 3.5.0
RUN wget https://releases.llvm.org/3.5.0/cfe-3.5.0.src.tar.xz && \
    tar xf cfe-3.5.0.src.tar.xz && \
    mv cfe-3.5.0.src llvm/tools/clang

# Download Compiler-RT 3.5.0
RUN wget https://releases.llvm.org/3.5.0/compiler-rt-3.5.0.src.tar.xz && \
