...
contract IOwned {
    ...
    function owner() public  returns (address owner) { owner; }
...
contract IERC20Token {
    ...
    function name() public  returns (string name) { name; }
    function symbol() public  returns (string symbol) { symbol; }
    function decimals() public  returns (uint8 decimals) { decimals; }
    ...
    function allowance(address _owner, address _spender) public  returns (uint256 remaining) { _owner; _spender; remaining; }
...
contract StoxSmartTokenSale is Ownable {
    ...
    uint256 public  EXCHANGE_RATE = 200; // 200 STX for ETH
