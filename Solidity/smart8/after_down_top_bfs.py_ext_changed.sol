...
contract PreSell is Ownable,ERC721{
    ...
    function initialCoach(uint _price,uint _emoterate,uint8 _category,uint _num) public          { 
    ...
    function setCoachPrice(uint _id,uint _price) public                 { 
        coaches[_id].isSell = 1;
        coaches[_id].sellPrice = _price;
    }
    function coachTakeOff(uint _id) public                 {
