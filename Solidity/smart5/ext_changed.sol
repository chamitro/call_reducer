...
//name: 0x0554c23993cad4c4baf5cc8296f003d1c68c0d75.sol
...
contract ValueToken is Lockable, TokenERC20 {
    ...
    uint internal  MIN_ETHER        = 1*1e16; // 0.01 ether
    uint internal  EXCHANGE_RATE    = 10000;  // 1 eth = 10000 VALUE
    ...
    function getContractBalanceOf() public  returns(uint blance) {
