...
BADCC1=()
BADCC3=()
BADCC2=("sudo docker run --rm -v $(pwd):/workspace gcc-4.8 gcc -O3 /workspace/small.c -o /work/t")
MODE=("-m32" "-m64")
...
GOODCC=("sudo docker run --rm -v $(pwd):/workspace gcc-4.8 gcc -O0 /workspace/small.c -o /work/t")
TIMEOUTCC=10
TIMEOUTEXE=2
TIMEOUTCCOMP=10
CFILE=$(pwd)/small.c
