...
BADCC=("sudo docker run --rm -v $(pwd):/workspace gcc-4.8.2 gcc -m32 -Os /workspace/$1 -o /work/t")
GOODCC=("sudo docker run --rm -v $(pwd):/workspace gcc-4.8.2 gcc -m32 -O0 /workspace/$1 -o /work/t")
TIMEOUT=10
CFILE=$(pwd)/$1
CFLAG="-o t"
