#!/bin/bash
BADCC1=("docker run --rm -v $(pwd):/work clang-3.6.0-assertions clang -O3 -m64 /work/small.c -o /work/t")
BADCC2=()
BADCC3=()
MODE=("-m64")
...
readonly CFLAG="-o t"
readonly CLANGFC="clang -w -m64 -O0 -Wfatal-errors -fwrapv -ftrapv -fsanitize=undefined,address"
