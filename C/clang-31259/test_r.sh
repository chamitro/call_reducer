...
BADCC1=()
BADCC2=()
BADCC3=("docker run --rm -v $(pwd):/work clang-3.8.0 clang -Os /work/$1 -o /work/t")
MODE=("-m32")
...
readonly GOODCC=("gcc -O0" "docker run --rm -v $(pwd):/workspace clang-3.7.0 clang -m32 -O1 /workspace/$1 -o /workspace/t")
