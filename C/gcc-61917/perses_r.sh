...
BADCC1=("docker run --rm -v $(pwd):/work gcc-4.9 gcc -m32 -O3 /work/small.c -o /work/t" "docker run --rm -v $(pwd):/work gcc-4.9 gcc -m64 -O3 /work/small.c -o /work/t")  # compilation failures
...
for cc in "${BADCC1[@]}" ; do
    ...
    # compile
    (timeout -s 9 $TIMEOUTCC $cc $CFLAG > out2.txt 2>&1) >& /dev/null
