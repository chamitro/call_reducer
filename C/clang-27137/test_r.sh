...
BADCC1=()
BADCC2=()
BADCC3=("docker run --rm -v $(pwd):/workspace clang-3.7.0 clang -O3 /workspace/$1 -o /workspace/t")
MODE=("-m32")
...
readonly GOODCC=("sudo docker run --rm -v $(pwd):/workspace gcc-4.8 gcc -m32 -O0 /workspace/$1 -o /workspace/t")
