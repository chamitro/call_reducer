#!/bin/bash
BADCC1=()
BADCC2=("docker run --rm -v $(pwd):/work clang-3.6.0 clang -O1 -m64 /work/$1 -o /work/t")
BADCC3=()
MODE=("-m64")
...
GOODCC=("sudo docker run --rm -v $(pwd):/workspace gcc-4.8 gcc -O0 /workspace/$1 -o /workspace/t")
TIMEOUTCC=15
TIMEOUTEXE=2
TIMEOUTCCOMP=10
CFILE=$(pwd)/$1
