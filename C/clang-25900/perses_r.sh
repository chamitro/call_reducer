#!/bin/bash
BADCC1=()
BADCC2=("docker run --rm -v $(pwd):/work clang-3.6.0 clang -O1 -m64 /work/small.c -o /work/t")
BADCC3=()
MODE=("-m64")
...
GOODCC=("sudo docker run --rm -v $(pwd):/workspace gcc-4.8 gcc -O0 /workspace/small.c -o /workspace/t")
TIMEOUTCC=10
TIMEOUTEXE=2
TIMEOUTCCOMP=10
CFILE=$(pwd)/small.c
CFLAG="-o t"
CLANGFC="clang -m64 -O0 -Wall -fwrapv -ftrapv -fsanitize=undefined,address"
...
if
  clang -pedantic  -O0 -c $CFILE  >out.txt 2>&1 &&\
