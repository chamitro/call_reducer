...
BADCC1=()
BADCC2=()
BADCC3=("sudo docker run --rm -v $(pwd):/workspace gcc-4.8 gcc -O3 /workspace/small.c -o /workspace/t")
MODE=("-m64")
...
readonly CFLAG="-o t"
readonly CLANGFC="gcc -m64 -O0 -Wall -fwrapv -ftrapv -fsanitize=undefined,address"
...
if
gcc -Wfatal-errors -pedantic -Wall -Wsystem-headers -O0 -c $CFILE  >out.txt 2>&1 &&\
